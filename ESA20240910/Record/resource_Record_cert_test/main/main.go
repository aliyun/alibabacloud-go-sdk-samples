...
func RatePlanInstCert (client *esa20240910.Client) (_result *esa20240910.PurchaseRatePlanResponseBody, _err error) {
...
func SiteCert (ratePlanInstCertResponseBody *esa20240910.PurchaseRatePlanResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateSiteResponseBody, _err error) {
...
func RecordCert (siteCertResponseBody *esa20240910.CreateSiteResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateRecordResponseBody, _err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call CreateRecord to create resource")
  data := &esa20240910.CreateRecordRequestData{
    Type: dara.Int32(111),
    KeyTag: dara.Int32(11),
    Algorithm: dara.Int32(11),
    Certificate: dara.String("eGVzdGFsbWNkbg=="),
  }
...
func UpdateRecordCert (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call UpdateRecord to update resource")
  data := &esa20240910.UpdateRecordRequestData{
    Type: dara.Int32(222),
    KeyTag: dara.Int32(22),
    Algorithm: dara.Int32(22),
    Certificate: dara.String("bGVzdGGsbWNkbg=="),
  }
...
func DestroyRecordCert (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
...
func _main (args []*string) (_err error) {
  ...
  // Init resource
  ratePlanInstCertRespBody, _err := RatePlanInstCert(esa20240910Client)
  if _err != nil {
    return _err
  }

  siteCertRespBody, _err := SiteCert(ratePlanInstCertRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  recordCertRespBody, _err := RecordCert(siteCertRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  // update resource
  _err = UpdateRecordCert(recordCertRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  // destroy resource
  _err = DestroyRecordCert(recordCertRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  return _err
