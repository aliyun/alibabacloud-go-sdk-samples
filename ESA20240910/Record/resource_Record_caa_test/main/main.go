...
func RatePlanInstCaa (client *esa20240910.Client) (_result *esa20240910.PurchaseRatePlanResponseBody, _err error) {
...
func SiteCaa (ratePlanInstCaaResponseBody *esa20240910.PurchaseRatePlanResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateSiteResponseBody, _err error) {
...
func Record (siteCaaResponseBody *esa20240910.CreateSiteResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateRecordResponseBody, _err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call CreateRecord to create resource")
  data := &esa20240910.CreateRecordRequestData{
    Value: dara.String("www.eerrraaa.com"),
    Tag: dara.String("issue"),
    Flag: dara.Int32(1),
  }
...
func UpdateRecord (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call UpdateRecord to update resource")
  data := &esa20240910.UpdateRecordRequestData{
    Value: dara.String("www.qwer.com"),
    Tag: dara.String("issuewild"),
    Flag: dara.Int32(1),
  }
...
func DestroyRecord (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
...
func _main (args []*string) (_err error) {
  ...
  // Init resource
  ratePlanInstCaaRespBody, _err := RatePlanInstCaa(esa20240910Client)
  if _err != nil {
    return _err
  }

  siteCaaRespBody, _err := SiteCaa(ratePlanInstCaaRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  recordRespBody, _err := Record(siteCaaRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  // update resource
  _err = UpdateRecord(recordRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  // destroy resource
  _err = DestroyRecord(recordRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  return _err
