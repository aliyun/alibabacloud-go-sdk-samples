...
func RecordCname (siteResponseBody *esa20240910.CreateSiteResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateRecordResponseBody, _err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call CreateRecord to create resource")
  authConf := &esa20240910.CreateRecordRequestAuthConf{
    SecretKey: dara.String("hijklmnhi**********mnhijklmn"),
    Version: dara.String("v4"),
    Region: dara.String("us-east-1"),
    AuthType: dara.String("private"),
    AccessKey: dara.String("abcdefgab*********efgabcdefg"),
  }
  data := &esa20240910.CreateRecordRequestData{
    Value: dara.String("www.idltestr.com"),
  }
  createRecordRequest := &esa20240910.CreateRecordRequest{
    ...
    Proxied: dara.Bool(true),
    SiteId: siteResponseBody.SiteId,
    Type: dara.String("CNAME"),
    SourceType: dara.String("S3"),
    Data: data,
    BizName: dara.String("api"),
    HostPolicy: dara.String("follow_hostname"),
    Ttl: dara.Int32(100),
    AuthConf: authConf,
  }
...
func UpdateRecordCname (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call UpdateRecord to update resource")
  authConf := &esa20240910.UpdateRecordRequestAuthConf{
    SecretKey: dara.String("secretkey0***********dcbafedcba"),
    Version: dara.String("v2"),
    Region: dara.String("us-gov-west-1"),
    AuthType: dara.String("private"),
    AccessKey: dara.String("AccessKey0**********edcbafedcba"),
  }
  data := &esa20240910.UpdateRecordRequestData{
    Value: dara.String("www.plexample.com"),
  }
  updateRecordRequest := &esa20240910.UpdateRecordRequest{
    ...
    Data: data,
    BizName: dara.String("api"),
    HostPolicy: dara.String("follow_origin_domain"),
...
func DestroyRecordCname (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
...
func _main (args []*string) (_err error) {
  ...
  recordCnameRespBody, _err := RecordCname(siteRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  // update resource
  _err = UpdateRecordCname(recordCnameRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  // destroy resource
  _err = DestroyRecordCname(recordCnameRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  return _err
