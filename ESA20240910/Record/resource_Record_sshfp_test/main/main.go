...
func RatePlanInstSshfp (client *esa20240910.Client) (_result *esa20240910.PurchaseRatePlanResponseBody, _err error) {
...
func SiteSshfp (ratePlanInstSshfpResponseBody *esa20240910.PurchaseRatePlanResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateSiteResponseBody, _err error) {
...
func RecordSshfp (siteSshfpResponseBody *esa20240910.CreateSiteResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateRecordResponseBody, _err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call CreateRecord to create resource")
  data := &esa20240910.CreateRecordRequestData{
    Fingerprint: dara.String("6262626475636f6d"),
    Type: dara.Int32(1),
    Algorithm: dara.Int32(1),
  }
...
func UpdateRecordSshfp (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
  fmt.Printf("[INFO] %s\n", "Begin Call UpdateRecord to update resource")
  data := &esa20240910.UpdateRecordRequestData{
    Fingerprint: dara.String("6464646475636f6d"),
    Type: dara.Int32(3),
    Algorithm: dara.Int32(3),
  }
...
func DestroyRecordSshfp (createRecordResponseBody *esa20240910.CreateRecordResponseBody, client *esa20240910.Client) (_err error) {
...
func _main (args []*string) (_err error) {
  ...
  // Init resource
  ratePlanInstSshfpRespBody, _err := RatePlanInstSshfp(esa20240910Client)
  if _err != nil {
    return _err
  }

  siteSshfpRespBody, _err := SiteSshfp(ratePlanInstSshfpRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  recordSshfpRespBody, _err := RecordSshfp(siteSshfpRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  // update resource
  _err = UpdateRecordSshfp(recordSshfpRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  // destroy resource
  _err = DestroyRecordSshfp(recordSshfpRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  return _err
