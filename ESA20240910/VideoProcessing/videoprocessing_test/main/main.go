...
func VideoProc(siteResponseBody *esa20240910.CreateSiteResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateVideoProcessingResponseBody, _err error) {
	fmt.Printf("[INFO] %s\n", "Begin Call CreateVideoProcessing to create resource")
	createVideoProcessingRequest := &esa20240910.CreateVideoProcessingRequest{
		VideoSeekEnable:  dara.String("on"),
		SiteId:           siteResponseBody.SiteId,
		RuleEnable:       dara.String("on"),
		FlvVideoSeekMode: dara.String("by_byte"),
		Mp4SeekEnd:       dara.String("end"),
		FlvSeekStart:     dara.String("start"),
		Rule:             dara.String("(http.host eq \"video.example.com\")"),
		Sequence:         dara.Int32(1),
		Mp4SeekStart:     dara.String("start"),
		SiteVersion:      dara.Int32(0),
		FlvSeekEnd:       dara.String("end"),
		RuleName:         dara.String("test"),
	}
	createVideoProcessingResponse, _err := client.CreateVideoProcessing(createVideoProcessingRequest)
	if _err != nil {
		return _result, _err
	}

	fmt.Printf("[INFO] %s\n", "Call CreateVideoProcessing success, response: ")
	fmt.Printf("[INFO] %s\n", util.ToJSONString(createVideoProcessingResponse))
	_result = createVideoProcessingResponse.Body
	return _result, _err
}

func UpdateVideoProc(siteResponseBody *esa20240910.CreateSiteResponseBody, createVideoProcessingResponseBody *esa20240910.CreateVideoProcessingResponseBody, client *esa20240910.Client) (_err error) {
	fmt.Printf("[INFO] %s\n", "Begin Call UpdateVideoProcessing to update resource")
	updateVideoProcessingRequest := &esa20240910.UpdateVideoProcessingRequest{
		VideoSeekEnable:  dara.String("off"),
		SiteId:           siteResponseBody.SiteId,
		RuleEnable:       dara.String("off"),
		FlvVideoSeekMode: dara.String("by_time"),
		Mp4SeekEnd:       dara.String("e"),
		FlvSeekStart:     dara.String("s"),
		Rule:             dara.String("(http.request.uri eq \"/content?page=1234\")"),
		Sequence:         dara.Int32(1),
		Mp4SeekStart:     dara.String("s"),
		FlvSeekEnd:       dara.String("e"),
		RuleName:         dara.String("test_modify"),
		ConfigId:         createVideoProcessingResponseBody.ConfigId,
	}
	updateVideoProcessingResponse, _err := client.UpdateVideoProcessing(updateVideoProcessingRequest)
	if _err != nil {
		return _err
	}

	fmt.Printf("[INFO] %s\n", "Call UpdateVideoProcessing success, response: ")
	fmt.Printf("[INFO] %s\n", util.ToJSONString(updateVideoProcessingResponse))
	return _err
}

func DestroyVideoProc(siteResponseBody *esa20240910.CreateSiteResponseBody, createVideoProcessingResponseBody *esa20240910.CreateVideoProcessingResponseBody, client *esa20240910.Client) (_err error) {
	fmt.Printf("[INFO] %s\n", "Begin Call DeleteVideoProcessing to destroy resource")
	deleteVideoProcessingRequest := &esa20240910.DeleteVideoProcessingRequest{
		SiteId:   siteResponseBody.SiteId,
		ConfigId: createVideoProcessingResponseBody.ConfigId,
	}
	deleteVideoProcessingResponse, _err := client.DeleteVideoProcessing(deleteVideoProcessingRequest)
	if _err != nil {
		return _err
	}

	fmt.Printf("[INFO] %s\n", "Call DeleteVideoProcessing success, response: ")
	fmt.Printf("[INFO] %s\n", util.ToJSONString(deleteVideoProcessingResponse))
	return _err
}
...
func _main(args []*string) (_err error) {
	...
	videoProcRespBody, _err := VideoProc(siteRespBody, esa20240910Client)
	if _err != nil {
		return _err
	}

	// update resource
	_err = UpdateVideoProc(siteRespBody, videoProcRespBody, esa20240910Client)
	if _err != nil {
		return _err
	}
	// destroy resource
	_err = DestroyVideoProc(siteRespBody, videoProcRespBody, esa20240910Client)
	if _err != nil {
		return _err
	}
	return _err
