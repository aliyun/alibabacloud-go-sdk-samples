...
func HttpBasicConf (ratePlanInstResponseBody *esa20240910.PurchaseRatePlanResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateSiteResponseBody, _err error) {
...
func HttpsBasicConf (httpBasicConfResponseBody *esa20240910.CreateSiteResponseBody, client *esa20240910.Client) (_result *esa20240910.CreateHttpsBasicConfigurationResponseBody, _err error) {
  ...
  createHttpsBasicConfigurationRequest := &esa20240910.CreateHttpsBasicConfigurationRequest{
    ...
    Ciphersuite: dara.String("TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256"),
    RuleEnable: dara.String("on"),
    Https: dara.String("on"),
    Http3: dara.String("on"),
    Http2: dara.String("on"),
    Tls10: dara.String("on"),
    Tls11: dara.String("on"),
    Sequence: dara.Int32(1),
    Tls12: dara.String("on"),
    Tls13: dara.String("on"),
    CiphersuiteGroup: dara.String("all"),
    Rule: dara.String("true"),
    RuleName: dara.String("test_global1"),
    OcspStapling: dara.String("on"),
  }
...
func UpdateHttpsBasicConf (httpBasicConfResponseBody *esa20240910.CreateSiteResponseBody, createHttpsBasicConfigurationResponseBody *esa20240910.CreateHttpsBasicConfigurationResponseBody, client *esa20240910.Client) (_err error) {
  ...
  updateHttpsBasicConfigurationRequest := &esa20240910.UpdateHttpsBasicConfigurationRequest{
    ...
    Http3: dara.String("off"),
    Http2: dara.String("off"),
    Tls10: dara.String("off"),
    Tls11: dara.String("off"),
    Sequence: dara.Int32(2),
    Tls12: dara.String("off"),
    Tls13: dara.String("off"),
    CiphersuiteGroup: dara.String("custom"),
    Rule: dara.String("true"),
    RuleName: dara.String("test_global1"),
    OcspStapling: dara.String("off"),
...
func DestroyHttpsBasicConf (httpBasicConfResponseBody *esa20240910.CreateSiteResponseBody, createHttpsBasicConfigurationResponseBody *esa20240910.CreateHttpsBasicConfigurationResponseBody, client *esa20240910.Client) (_err error) {
...
func _main (args []*string) (_err error) {
  ...
  httpBasicConfRespBody, _err := HttpBasicConf(ratePlanInstRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  httpsBasicConfRespBody, _err := HttpsBasicConf(httpBasicConfRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }

  // update resource
  _err = UpdateHttpsBasicConf(httpBasicConfRespBody, httpsBasicConfRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  // destroy resource
  _err = DestroyHttpsBasicConf(httpBasicConfRespBody, httpsBasicConfRespBody, esa20240910Client)
  if _err != nil {
    return _err
  }
  return _err
